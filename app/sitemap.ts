...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/editorial-policy`,                              priority: 0.4,  changeFrequency: 'yearly',  lastModified: now },
    { url: `${BASE_URL}/medical-disclaimer`,                            priority: 0.4,  changeFrequency: 'yearly',  lastModified: now },
