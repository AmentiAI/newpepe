...
const declineFactors = [
  { factor: 'Age (natural decline)', rate: '1–2% per year after age 25', icon: Clock, color: 'text-slate-400' },
    ...
    <main className="min-h-screen bg-dark-900 text-slate-200">
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto space-y-10">
          <div className="text-center space-y-3">
            <h2 className="text-3xl font-bold text-white">Why Collagen is the Foundation of Appearance</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {collagenTypes.map((ct) => (
              <div key={ct.type} className={`glass-card p-5 space-y-3 border ${ct.color}`}>
                ...
                <p className="text-slate-400 text-xs font-semibold uppercase tracking-wide">{ct.locations}</p>
                <p className="text-slate-300 text-sm leading-relaxed">{ct.importance}</p>
                <div className="pt-2 border-t border-slate-700/50">
                  <span className="text-slate-500 text-xs">Best peptide: </span>
      ...
      <section className="py-16 px-4 bg-slate-900/30">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="text-center space-y-3">
            <h2 className="text-3xl font-bold text-white">How Collagen Declines — and What Accelerates It</h2>
            <p className="text-slate-400 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {declineFactors.map((factor) => (
                <div key={factor.factor} className="flex items-start gap-3 p-3 bg-slate-800/60 rounded-xl">
                  ...
                  <div>
                    <p className="text-slate-200 text-sm font-semibold">{factor.factor}</p>
                    <p className="text-slate-400 text-xs mt-0.5">{factor.rate}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="text-center space-y-3">
            <h2 className="text-3xl font-bold text-white">Peptides Ranked by Collagen-Boosting Evidence</h2>
            <p className="text-slate-400 max-w-2xl mx-auto">
      ...
      <section className="py-16 px-4 bg-slate-900/30">
        <div className="max-w-4xl mx-auto space-y-8">
          <h2 className="text-3xl font-bold text-white">#1: GHK-Cu — The Collagen Reset Peptide</h2>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto space-y-8">
          <h2 className="text-3xl font-bold text-white">#2: BPC-157 — The Angiogenesis-to-Collagen Pipeline</h2>
          <div className="glass-card p-8 space-y-5">
            <p className="text-slate-300 leading-relaxed">
      ...
      <section className="py-16 px-4 bg-slate-900/30">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="text-center space-y-3">
            <h2 className="text-3xl font-bold text-white">The Synergistic Collagen Stack</h2>
            <p className="text-slate-400 max-w-2xl mx-auto">
            ...
            {synergyStack.map((item, i) => (
              <div key={item.peptide} className="glass-card p-5 space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-bold text-slate-100">{item.peptide}</span>
                </div>
                <p className="text-slate-400 text-sm">{item.role}</p>
                <div className="pt-2 border-t border-slate-700/50 space-y-1">
                  <p className="text-amber-300 text-xs"><span className="text-slate-500">Dose:</span> {item.dose}</p>
                  <p className="text-teal-300 text-xs"><span className="text-slate-500">Timing:</span> {item.timing}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto space-y-8">
          <h2 className="text-3xl font-bold text-white">Diet &amp; Lifestyle Factors That Amplify Results</h2>
          <div className="glass-card p-8 space-y-5">
            <p className="text-slate-300 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={item.title} className="flex items-start gap-3 p-4 bg-slate-800/60 rounded-xl">
                  ...
                  <div>
                    <p className="text-slate-200 font-semibold text-sm">{item.title}</p>
      ...
      <section className="py-16 px-4 bg-slate-900/30">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="text-center space-y-3">
            <h2 className="text-3xl font-bold text-white">Realistic Collagen Rebuilding Timeline</h2>
            <p className="text-slate-400 max-w-2xl mx-auto">
      ...
      <section className="py-16 px-4 bg-slate-900/30">
        <div className="max-w-2xl mx-auto text-center space-y-6">
          ...
          <h2 className="text-3xl font-bold text-white">Start Your Collagen Protocol</h2>
